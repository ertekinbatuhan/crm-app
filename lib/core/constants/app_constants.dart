...
class AppStrings {
  ...
  static const String startByAddingContact =
...
class AppTextStyles {
  ...
  static const TextStyle errorMessage = TextStyle(fontSize: AppSizes.fontM);

  static const TextStyle buttonText = TextStyle(fontSize: AppSizes.fontL);
